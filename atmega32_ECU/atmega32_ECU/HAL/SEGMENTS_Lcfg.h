...
//cathode
//LEFT
#define		SEGMENT_LEFT_A	PINA0
#define		SEGMENT_LEFT_B	PINA1
#define		SEGMENT_LEFT_C	PINA2
#define		SEGMENT_LEFT_D	PINA3
#define		SEGMENT_LEFT_E	PINA4
#define		SEGMENT_LEFT_F	PINA5
#define		SEGMENT_LEFT_G	PINA6

//cathode
//RIGHT
#define		SEGMENT_RIGHT_A	PINB0
#define		SEGMENT_RIGHT_B	PINB1
#define		SEGMENT_RIGHT_C	PINB2
#define		SEGMENT_RIGHT_D	PINB3
#define		SEGMENT_RIGHT_E	PINB4
#define		SEGMENT_RIGHT_F	PINB5
#define		SEGMENT_RIGHT_G	PINB6
